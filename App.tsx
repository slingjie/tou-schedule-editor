...
const App: React.FC = () => {
  ...
  return (
    <>
            ...
            <div className="flex-1 flex justify-center">
              <div className="bg-slate-200 rounded-lg p-1 flex space-x-1">
                ...
                <button
                  ...
                  className="bg-slate-100/50 hover:bg-slate-200 text-slate-600 px-3 py-1.5 rounded-md text-sm border border-slate-200/50 flex items-center gap-1 transition-colors"
                  title="Configure Cloud Sync API Key"
                >
                  <span className="text-xs">☁️</span> Sync
                </button>
      ...
      <SyncSettingsModal isOpen={isSyncModalOpen} onClose={() => setIsSyncModalOpen(false)} />
